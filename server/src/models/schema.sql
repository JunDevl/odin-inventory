...
CREATE TABLE entities_franchises (
  ...
  FOREIGN KEY (user_id, entity_id) REFERENCES entities (user_id, entity_id) ON DELETE CASCADE,
...
CREATE TABLE outsourced_entity_franchise_types (
  ...
  FOREIGN KEY (user_id, entity_id, franchise_id) REFERENCES entities_franchises (user_id, entity_id, franchise_id) ON DELETE CASCADE,
...
CREATE TABLE categories_of_items (
  ...
  FOREIGN KEY (item_user_id, item_id) REFERENCES items (user_id, item_id) ON DELETE CASCADE,
...
CREATE TABLE items_unit_price_history (
  user_id uuid REFERENCES users,
  item_id INTEGER ON DELETE CASCADE,
