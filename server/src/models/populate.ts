...
const populateDb = async () => {
  await sql`
    ...
    CREATE TABLE users_entities_franchises (
      ...
      address TEXT NOT NULL UNIQUE // think a bit more about this property. Should it be here? Is this table even necessary?
    );
    ...
    CREATE TABLE entities_franchises (
      ...
      PRIMARY KEY (entity_id, franchise_id)
    );
    ...
    CREATE TABLE entities_storage_areas (
      owner_id INTEGER REFERENCES entities,
      owner_franchise_id INTEGER REFERENCES entities_franchises,
      created_by INTEGER REFERENCES users NOT NULL,
      address TEXT NOT NULL UNIQUE,

      PRIMARY KEY (owner_id, owner_franchise_id)
    );
